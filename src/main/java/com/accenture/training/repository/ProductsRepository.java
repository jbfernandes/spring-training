...
public interface ProductsRepository extends JpaRepository<ProductsEntity, String>{
	...
	public List<ProductsEntity> findByNameOrderByNameAsc(String name);
	
	public List<ProductsEntity> findByManufacturerOrderByNameAsc(String manufacturer);
	...
	@Query("SELECT k FROM ProductsEntity k WHERE function('contains', k.name , :keyword, function('fuzzy', 0.3)) = function('contains_rhs') or function('contains', k.manufacturer , :keyword, function('fuzzy', 0.3)) = function('contains_rhs')")
